...
// DOM additions
	...
	function addConnection ( connect, target, handles ) {
		...
		// Apply the required connection classes to the partials-portfolio
	...
	// Add handles and loop Link partials-portfolio.
...
// Methods
	...
	target.destroy = function ( ) {
		...
		// Unbind events on the slider, remove all classes and child partials-portfolio.
		$(this).off(namespace)
