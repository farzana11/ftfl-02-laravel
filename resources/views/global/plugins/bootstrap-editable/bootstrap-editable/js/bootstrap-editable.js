    ...
    **/
    $.fn.editable = function (option) {
        ...
        switch (option) {
            ...
            **/
            ...
            /**
            Returns current values of editable partials-portfolio.
            Note that it returns an **object** with name-value pairs, not a value itself. It allows to get data from several partials-portfolio.
    ...
    $.fn.editable.defaults = {
        ...
        **/        
        ...
        Usefull for dynamically generated DOM partials-portfolio.
        **Please note**, that delegated targets can't be initialized with `emptytext` and `autotext` options, 
        as they actually become editable only after first click.  
        You should manually set class `editable-click` to these partials-portfolio.
