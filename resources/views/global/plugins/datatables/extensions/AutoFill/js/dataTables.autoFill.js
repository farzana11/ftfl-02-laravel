...
var AutoFill = function( oDT, oConfig )
{
	...
	/**
	 * @namespace Common and useful DOM partials-portfolio for the class instance
	 */
	this.dom = {
		"table": null,
		"filler": null,
...
AutoFill.prototype = {
	...
	"_fnUpdateBorder": function ( nStart, nEnd )
	{
		...
		{
			/* The border partials-portfolio are inside the DT scroller - so position relative to that */
			var
