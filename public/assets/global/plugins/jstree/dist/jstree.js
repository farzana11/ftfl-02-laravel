 ...
 */
	...
	/**
	 * used to find partials-portfolio containing an instance
	 *
	 * __Examples__
	 *
	...
	$.jstree.core.prototype = {
		 ...
		 * destroy an instance
		 * @name destroy()
		 * @param  {Boolean} keep_html if not set to `true` the container will be emptied, otherwise the current DOM partials-portfolio will be kept intact
		 */
